module.exports = {
  ...
  update: function(list, theme, folder, post){
    ...
    return result + `
        ...
        <div class="middle">
          <h2>${folder}</h2>
          <form action="/create_process" method="post" id="menu-create" enctype="multipart/form-data">
    ...
    return result + `
        ${menus}
        <a href="/create?theme=${theme}&id=${folder}" id="menu-create" class="menu">create</a>
        <form action="/update?theme=${theme}&id=${folder}" method="post" id="menu-update">
        ...
        <form action="/delete_process?theme=${theme}&id=${folder}" method="post" id="menu-delete">
